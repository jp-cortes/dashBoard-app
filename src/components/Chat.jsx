        ...
        <div className="flex justify-between items-center">
            ...
            <div className="mt-5">
                {chatData.map((item, index) => (
                    <div key={index} className="flex item-center gap-5 border-color p-3 leading-8 cursor-pointer">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 dark:text-gray-400 text-xm">{item.time}</p>
                        </div>
                    </div>
                ))}
                <div className="mt-5">
